...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, primary_key=True)),
                ('user_priority', models.PositiveIntegerField(validators=[django.core.validators.MaxValueValidator(9999999999L)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority_level', models.PositiveIntegerField(validators=[django.core.validators.MaxValueValidator(9999999999L)])),
            ],
        ),
        migrations.CreateModel(
            name='Resource',
            fields=[
                ...
                ('description', models.CharField(max_length=512)),
                ('remained', models.PositiveIntegerField(validators=[django.core.validators.MaxValueValidator(9999999999L)])),
                ('remained_alarm', models.PositiveIntegerField(validators=[django.core.validators.MaxValueValidator(9999999999L)])),
            ],
        ),
        migrations.CreateModel(
            name='Resource_using',
            fields=[
                ...
                ('amount', models.PositiveIntegerField(validators=[django.core.validators.MaxValueValidator(9999999999L)])),
                ('comment', models.CharField(max_length=256)),
                ('member_id', models.ForeignKey(to='core.User')),
        ...
        migrations.AddField(
            model_name='log',
            name='member_id',
            field=models.ForeignKey(default=datetime.datetime(2017, 5, 16, 11, 7, 52, 965000, tzinfo=utc), to='core.User'),
